    ...
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#1a8cd8] transition-colors font-medium"
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#0077B5] text-white rounded-lg hover:bg-[#006399] transition-colors font-medium"
